...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(characters.name) FROM series JOIN characters ON series.id = characters.series_id JOIN books ON books.series_id = characters.series_id GROUP BY characters.name"
end
